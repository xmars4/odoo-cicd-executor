...
1. Go to [repo settings](https://github.com/xmars4/odoo-cicd-executor/settings/environments) and create a new environment named *(1)* with the following secrets and variables:
